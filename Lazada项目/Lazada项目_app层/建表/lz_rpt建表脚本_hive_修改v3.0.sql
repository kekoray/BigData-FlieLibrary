...
(
   ...
   `item_count`                  bigint             comment  '产品总数',
   `review_count`                bigint             comment  '评价总数',

   `review_add_1day`          bigint             comment  '近1天新增评价数 [新增评论数之和]',
   `item_add_1day`            bigint             comment  '近1天新增产品数 [新增产品数之和]',
   `shop_add_1day`            bigint             comment  '近1天新增店铺数 [新增店铺数之和]',
   `orig_price_ave_1day`      decimal(10,2)      comment  '近1天原价均价 [原价的总销售额/总评价数]',
   `sale_price_ave_1day`      decimal(10,2)      comment  '近1天折扣均价 [折扣价的总销售额/总评价数]',
   `item_reviewRate_1day`     decimal(10,2)      comment  '近1天产品评价率 [有评价的产品数/总产品数]',
   `review_addRate_1day`     decimal(10,2)      comment  '近1天评价增长率 [(T周期总评价数-(T-1)周期评价数)/(T-1)周期总评价数]',
   `newItem_ave_1day`        bigint             comment  '近1天平均上新产品数 [上新产品数之和/总时间]',
   `review_avg_1day`          bigint             comment  '近1天平均评价数 [评价数之和/总时间]',

  `review_add_7day`           bigint             comment  '近7天新增评价数',
  ...
  `item_reviewRate_7day`      decimal(10,2)      comment  '近7天产品评价率',
  `review_addRate_7day`      decimal(10,2)      comment  '近7天评价增长率',
  `new_item_ave_7day`         bigint             comment  '近7天平均上新产品数',
  `review_avg_7day`           bigint             comment  '近7天平均评价数',

   `review_add_30day`           bigint             comment  '近30天新增评价数',
   ...
   `item_reviewRate_30day`      decimal(10,2)      comment  '近30天产品评价率',
   `review_addRate_30day`      decimal(10,2)      comment  '近30天评价增长率',
   `new_item_ave_30day`         bigint             comment  '近30天平均上新产品数',
   `review_avg_30day`           bigint             comment  '近30天平均评价数',
...
(
   ...
   `item_count`                  bigint                comment '产品总数',
   `review_count`                bigint                comment '评价总数',
   `review_add_1day`            bigint                comment '近1天新增评价数',
   ...
   `item_reviewRate_7day`      decimal(10,2)         comment '7天产品评价率',
   `review_addRate_7day`       decimal(10,2)         comment '7天评价增长率',
   `new_item_ave_7day`    bigint                comment '7天平均上新产品数',
   `review_avg_7day`        bigint                comment '7天平均评价数',
   `orig_price_ave_30day`       decimal(10,2)         comment '30天原价均价',
   `sale_price_ave_30day`           decimal(10,2)         comment '30天折扣均价',
   `review_avg_30day`        bigint                comment '30天平均评价数',
   `review_addRate_1day`         decimal(10,2)         comment '近1天评价增长率',
   `review_addRate_30day`       decimal(10,2)         comment '近30天评价增长率',
   `create_time`                string                comment '创建时间'
...
(
   ...
   `site_id`                  string           comment '站点ID',
   `review_count`            bigint           comment '评价总数',
   `review_acco`            decimal(5,2)     comment '评价总数占比 [子行业评价数/父行业评价总数]',
   `item_add_7day`       bigint           comment '近7天新增产品数',
   `item_add_30day`       bigint           comment '近30天新增产品数',
   `itemAdd_acco_7day`        decimal(5,2)     comment '近7天新增产品数占比 [子行业新增产品数/父行业新增产品总数]',
   `itemAdd_acco_30day`         decimal(5,2)     comment '近30天新增产品数占比',
   `create_time`               string           comment '创建时间'
...
(
   ...
   `site_id`              string           comment '站点ID',
   `review_count`           bigint           comment '评价总数',
   `review_acco`            decimal(5,2)     comment '评价总数占比 [单站的评价总数/全站的评价总数]',

   `review_add_1day`        bigint           comment '近1天新增评价数',
   `review_acco_1day`        decimal(5,2)     comment '近1天新增评价占比',

   `review_add_7day`      bigint           comment '近7天新增评价数',
   `review_acco_7day`      decimal(5,2)     comment '近7天新增评价占比',

   `review_add_30day`      bigint           comment '近30天新增评价数',
   `review_acco_30day`      decimal(5,2)     comment '近30天新增评价占比',
   `create_time`           string           comment '创建时间'
)comment '全站-产品分析-各站点产品评价数占比图'
partitioned by (
    `dt` string  comment '日期分区字段{"format":"yyyy-MM-dd"}')
row format delimited
    fields terminated by '\t'
...
(
   ...
   `hasEval_type`     string          comment '有无评价的产品 (1.总产品 2.有评价的产品 3.无评价的产品)',
   `create_time`      string          comment '创建时间'
...
(
   ...
   `review_count_7day`           bigint             comment '近7天评价总数',
   `review_avg_7day`       bigint             comment '近7天平均评价数',
   `review_addRate_7day`      decimal(10,2)      comment '近7天评价增长率',

   `review_count_30day`           bigint             comment '近30天评价总数',
   `review_addRate_30day`      decimal(10,2)      comment '近30天评价增长率',
...
(
   ...
   `item_addRate_1day`               decimal(10,2)       comment '近1天产品环比增幅 [(T期该店类品总数-(T-1)期该店类品总数)/(T-1)期该店类品总数]',

   `itemReviewType_count`                  bigint              comment '有评价产品总数',
   `itemReviewType_acco`                   decimal(5,2)        comment '有评价产品总数占比 [各店铺类型/全站]',
   `itemReviewType_addRate_1day`            decimal(10,2)       comment '近1天有评价产品环比增幅 [(T期该店类品总数-(T-1)期该店类品总数)/(T-1)期该店类品总数]',

   `newItem_count_7day`             bigint              comment '近7天上新产品总数',
   `newItem_acco_7day`              decimal(5,2)        comment '近7天上新产品总数占比',
   `newItem_addRate_7day`       decimal(10,2)       comment '近7天上新产品环比增幅',

   `newItem_count_30day`              bigint     comment '近30天上新产品总数',
   `newItem_acco_30day`              decimal(5,2)        comment '近30天上新产品总数占比',
   `newItem_addRate_30day`       decimal(10,2)       comment '近30天上新产品环比增幅',



   `newitemReviewType_count_7day`        bigint              comment '近7天上新有评价产品总数',
   `newitemReviewType_acco_7day`         decimal(5,2)        comment '近7天上新有评价产品总数占比',
   `newitemReviewType_addRate_7day`        decimal(10,2)       comment '近7天上新有评价产品环比增幅',

   `newitemReviewType_count_30day`        bigint              comment '近30天上新有评价产品总数',
   `newitemReviewType_acco_30day`         decimal(5,2)        comment '近30天上新有评价产品总数占比',
   `newitemReviewType_addRate_30day`        decimal(10,2)       comment '近30天上新有评价产品环比增幅',


   `review_count_7day`                 bigint              comment '近7天评价总数',
   `review_acco_7day`                  decimal(5,2)        comment '近7天评价总数占比',
   `review_addRate_7day`           decimal(10,2)       comment '近7天评价数环比增幅',

  `review_count_30day`                 bigint              comment '近30天评价数',
   `review_acco_30day`                  decimal(5,2)        comment '近30天评价数总数占比',
   `review_addRate_30day`           decimal(10,2)       comment '近30天评价数环比增幅',

   `review_avg_7day`                  bigint              comment '近7天平均评价数',
   `review_avg_acco_7day`              decimal(5,2)        comment '近7天平均评价数总数占比',
   `review_avg_addRate_7day`       decimal(10,2)       comment '近7天平均评价数环比增幅',



   `item_avgReviewRate_7day`               decimal(10,2)       comment '近7天平均产品评价率(动销率) [7天有评价的产品数/7天总产品数/7]',
   `item_avgReviewRate_acco_7day`          decimal(5,2)        comment '近7天平均产品评价率占比 [各店铺类型/全站]',
   `item_avgReviewRate_addRate_7day`         decimal(10,2)       comment '近7天平均产品评价率环比增幅 [(T期该店类总率-(T-1)期该店类总率)/(T-1)期该店类总率]',
...
(
   ...
   `7dayReview_set`         string           comment '7天平均评价数区间(1.1-10,2.11-30,3.31-50,4.51-100,5.101-200,6.201-300,7.301+~ )',
  `item_count`             bigint            comment '区间对应的产品总数',
   ...
   `create_time`              string          comment '创建时间'
)comment '全站/分站-店铺分析/产品分析-产品7日平均评价数分布'
partitioned by (
    `dt` string  comment '日期分区字段{"format":"yyyy-MM-dd"}')
row format delimited
    fields terminated by '\t'
...
(
   ...
   `item_add_30day`      bigint              comment '近30天新增产品数',
   `review_add_30ay`      bigint              comment '近30天新增评价数',
   `itemAdd_acco_30day`      decimal(5,2)        comment '近30天新增产品占比',
   `review_acco_30day`      decimal(5,2)        comment '近30天新增评价占比',
...
(
   ...
   `cat_potential`           bigint    comment '行业潜力值 [该子类目总评价数/该子类目总产品数]',
   `create_time`             string    comment '创建时间'
...
(
   ...
   `review_avg_7day`          bigint            comment '7天平均评价数 [7天评价总数/7]',

   
   `review_addRate_1day`          decimal(10,2)     comment '近1天评价增长率',
   `item_reviewRate_1day`              decimal(5,2)      comment '近1天产品评价率',

   `itemReviewType_salePrice_avg`         decimal(10,2)     comment '有评价产品折扣均价',
   `itemReviewType_origPrice_avg`     decimal(10,2)     comment '有评价产品原价均价',

   `item_add_1day`                 bigint            comment '近1天新增产品数',
   `itemReviewType_add_1day`       bigint            comment '近1天新增有评价产品数',
   `itemReviewType_count`          bigint            comment '有评价产品总数',
...
(
   ...
   `item_count`                      bigint                comment '产品总数',
   `itemReviewType_salePrice_avg`     decimal(10,2)         comment '有评价产品折扣均价',
   `item_reviewRate_1day`             decimal(5,2)          comment '近1天产品评价率 [有评价的产品数/总产品数]',
...
(
   ...
   `review_addRate_7day`    decimal(10,2)    comment '近7天评价增长率  [(T期总评价数-(T-1)期总评价数)/(T-1)期总评价数]',
...
(
   ...
   `create_time`           string            comment '创建时间'
)comment '产品分析-产品详情页-产品sku分析-SKU评价数的星级分布表'
partitioned by (
    `dt` string  comment '日期分区字段{"format":"yyyy-MM-dd"}')
row format delimited
    fields terminated by '\t'
...
(
   ...
   `shop_addRate_1day`      decimal(10,2)       comment '近1天店铺环比增幅',

   `shopReviewType_count`        bigint              comment '有评价店铺总数',
   `shopReviewType_acco`             decimal(5,2)        comment '有评价店铺总数占比',
   `shopReviewType_addRate_1day`           decimal(10,2)       comment '近1天有评价店铺环比增幅',

   `shop_add_7day`       bigint              comment '近7天新增店铺数',
   `shopAdd_acco_7day`        decimal(5,2)        comment '近7天新增店铺数占比',
   `shop_addRate_7day`      decimal(10,2)       comment '7日新增店铺环比增幅',
...
(
   ...
   `review_addRate_1day`         decimal(10,2)   comment '近1天评价环比增幅 [(T期评价总数-(T-1)期评价总数)/(T-1)期评价总数]',
   `review_acco`        decimal(5,2)    comment '评论总数占比 [子行业评价数/父行业评价总数]',
