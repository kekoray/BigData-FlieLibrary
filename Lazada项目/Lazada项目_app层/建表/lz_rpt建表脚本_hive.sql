...
(
   ...
   `item_eval_rate`       string comment '产品评价率',
   `eval_gro_rate`        string comment '评价增长率',
...
(
   ...
   `day_eval_num`         bigint comment '日评价数',
   `yest_eval_gro_rate`   string comment '昨日评价增长率',
   `weeks_eval_num`       bigint comment '7天评价数',
   `weeks_ave_eval_num`   bigint comment '7天平均评价数',
   `weeks_eval_gro_rate`  string comment '7天评价增长率',
   `month_eval_num`       bigint comment '30天评价数',
   `month_eval_gro_rate`  string comment '30天评价增长率',
   `gmt_create`           string comment '创建时间' 
)comment '行业-行业产品'
partitioned by (
    `dt` string  comment '日期分区字段{"format":"yyyymmdd"}')
...
(
   ...
   `weeks_item_eval_rate` string comment '7天产品评价率',
   `weeks_eval_gro_rate`  string comment '7天评价增长率',
   ...
   `day_eval_gro_rate`    string comment '近一天评价增长率',
   `month_eavl_gro_rate`  string comment '近30天评价增长率',
   `gmt_create`           string comment '创建时间'  
...
(
   ...
   `eval_count`                 string comment '累计评价数',
   ...
   `weeks_eval_num_gro_rate`    string comment '7天评价数增长率',
   `day_eval_num`               bigint comment '日评论数',
   `on_time_delivery_rate`      string comment '准时送达率',
   `gmt_create`                 string comment '创建时间'
)comment '行业-行业店铺'
partitioned by (
    `dt` string  comment '日期分区字段{"format":"yyyymmdd"}')
...
(
   ...
   `category_id`          bigint comment '行业 ID',
   `site_id`              bigint comment '站点 ID',
   `eval_num`             string comment '评价量',
   `acco`                 string comment '比例',
   `weeks_new_item_num`   bigint comment '近7天新增产品量',
   `month_new_item_num`   bigint comment '近30天新增产品量',
   `weeks_acco`           string comment '近7天比例',
   `month_acco`           string comment '近30天比例',
   `gmt_create`           string comment '创建时间' 
)comment '行业-子行业占比图'
partitioned by (
    `dt` string  comment '日期分区字段{"format":"yyyymmdd"}')
...
(
   `id`                   bigint  comment '主键',
   `site_id`              bigint comment '站点 ID',
   `eval_count`           string comment '评价总量',
   `eval_acco`            string comment '评价占比',
   `day_eval_incr`        bigint comment '近1天评价增量',
   `day_eval_acco`        string comment '近1天评价占比',
   `weeks_eval_incr`      bigint comment '近7天评价增量',
   `weeks_eval_acco`      string comment '近7天评价占比',
   `month_eval_incr`      bigint comment '近30天评价增量',
   `month_eval_acco`      string comment '近30天评价占比',
   `gmt_create`           string comment '创建时间'
...
(
   `id`                   bigint  comment '主键',
   `site_id`              bigint comment '站点 ID',
   `item_count`           string comment '产品总量',
   `item_acco`            string comment '产品占比',
   `day_item_incr`        bigint comment '近1天产品增量',
   `day_item_acco`        string comment '近1天产品占比',
   `weeks_item_incr`      bigint comment '近7天产品增量',
   `weeks_item_acco`      string comment '近7天产品占比',
   `month_item_incr`      bigint comment '近30天产品增量',
   `month_item_acco`      string comment '近30天产品占比',
   `gmt_create`           string comment '创建时间'
...
(
   ...
   `item_acco`                            string     comment '产品全站占比',
   `item_cycle_ratio`                     string     comment '产品环比增幅',
   `eval_item_count`                      bigint     comment '有评价产品总量',
   `eval_item_acco`                       string     comment '有评价产品全站占比',
   `eval_item_cycle_ratio`                string     comment '有评价产品环比增幅',
   `month_new_item_count`                 bigint     comment '30日上新产品总量',
   `month_new_item_acco`                  string     comment '30日上新产品全站占比',
   `month_new_item_cycle_ratio`           string     comment '30日上新产品环比增幅',
   `month_new_eval_item_count`            bigint     comment '30日上新有评价产品总量',
   `month_new_eval_item_acco`             string     comment '30日上新有评价产品全站占比',
   `month_new_eval_item_ratio`            string     comment '30日上新有评价产品环比增幅',
   `month_eval_count`                     bigint     comment '30日评价量',
   `month_eval_acco`                      string     comment '30日评价量全站占比',
   `month_eval_cycle_ratio`               string     comment '30日评价量环比增幅',
   `weeks_new_item_count`                 bigint     comment '7日上新产品总量',
   `weeks_new_item_acco`                  string     comment '7日上新产品全站占比',
   `weeks_new_item_cycle_ratio`           string     comment '7日上新产品环比增幅',
   `weeks_eval_count`                     bigint     comment '7日评价量',
   `weeks_eval_acco`                      string     comment '7日评价量全站占比',
   `weeks_eval_cycle_ratio`               string     comment '7日评价量环比增幅',
   `weeks_new_eval_item_count`            bigint     comment '7日上新有评价产品总量',
   `weeks_new_eval_item_acco`             string     comment '7日上新有评价产品全站占比',
   `weeks_new_eval_item_ratio`            string     comment '7日上新有评价产品环比增幅',
   `weeks_ave_eval_count`                 bigint     comment '7日日均评价量',
   `weeks_ave_eval_acco`                  string     comment '7日日均评价量全站占比',
   `weeks_ave_eval_cycle_ratio`           string     comment '7日日均评价量环比增幅',
   `weeks_ave_pin_rate`                   string     comment '7日日均动销率',
   `weeks_ave_pin_rate_acco`              string     comment '7日日均动销率全站占比',
   `weeks_ave_pin_rate_ratio`             string     comment '7日日均动销率环比增幅',
...
(
   ...
   `item_acco`            string comment '近1天产品数占比',
   `eval_acco`            string comment '近1天评论数占比',
   `weeks_item_incr`      bigint comment '近7天产品增量',
   `weeks_eval_incr`      bigint comment '近7天评论增量',
   `weeks_item_acco`      string comment '近7天产品数占比',
   `weeks_eval_acco`      string comment '近7天评论数占比',
   `month_item_incr`      bigint comment '近30天产品增量',
   `month_eval_incr`      bigint comment '近30天评论增量',
   `month_item_acco`      string comment '近30天产品数占比',
   `month_eval_acco`      string comment '近30天评论数占比',
   `gmt_create`           string comment '创建时间'
)comment '分站行业分析-行业概况'
partitioned by (
    `dt` string  comment '日期分区字段{"format":"yyyymmdd"}')
...
(
   ...
   `eval_incr`            bigint comment '近1天评论增量',
   `shop_acco`            string comment '近1天店铺数占比',
   `eval_acco`            string comment '近1天评论数占比',
   `weeks_shop_incr`      bigint comment '近7天店铺增量',
   `weeks_eval_incr`      bigint comment '近7天评论增量',
   `weeks_shop_acco`      string comment '近7天店铺数占比',
   `weeks_eval_acco`      string comment '近7天评论数占比',
   `month_shop_incr`      bigint comment '近30天店铺增量',
   `month_eval_incr`      bigint comment '近30天评论增量',
   `month_shop_acco`      string comment '近30天店铺数占比',
   `month_eval_acco`      string comment '近30天评论数占比',
   `gmt_create`           string comment '创建时间'
...
(
   ...
   `day_acco`             string comment '近1天占比',
   `weeks_acco`           string comment '近7天占比',
   `month_acco`           string comment '近30天占比',
   `gmt_create`           string comment '创建时间'
...
(
   ...
   `shop_acco`                  string comment '店铺全站占比',
   `shop_growth`                string comment '店铺环比增幅',
   `eval_shop_count`            string comment '有评价店铺总数',
   `eval_shop_acco`             string comment '有评价全站占比',
   `eval_shop_growth`           string comment '有评价店铺环比增幅',
   `weeks_new_shop_count`       string comment '7日新增店铺总数',
   `weeks_new_shop_acco`        string comment '7日新增店铺全站占比',
   `weeks_new_shop_growth`      string comment '7日新增店铺环比增幅',
   `gmt_create`                 string comment '创建时间'
)comment '店铺分析-店铺统计'
partitioned by (
    `dt` string  comment '日期分区字段{"format":"yyyymmdd"}')
...
(
   ...
   `category_id`          bigint comment '行业 ID',
   `site_id`              bigint comment '站点 ID',
   `item_count`           string comment '商品总数',
   `eval_item_count`      string comment '有评价商品总数',
   `eval_num`             string comment '评价数',
   `eval_num_gro`         string comment '评价数增幅',
   `eval_num_acco`        string comment '评价数占比',
   `shop_num`             bigint comment '店铺数',
   `gmt_create`           string comment '创建时间'
